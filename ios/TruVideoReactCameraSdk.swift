...
//    new function added
  ...
  @objc(isAugmentedRealityInstalled:withRejecter:)
  public func isAugmentedRealityInstalled(resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
      resolve("true")
  }
  
  @objc(isAugmentedRealitySupported:withRejecter:)
  public func isAugmentedRealitySupported(resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock){
      resolve("true")
  }
  
  
  
  @objc(initARCameraScreen:withResolver:withRejecter:)
  public func initARCameraScreen(configuration: String, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
